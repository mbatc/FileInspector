...
void ImGui_ImplGlfw_CursorPosCallback(GLFWwindow* window, double x, double y)
{
    ...
    ImGuiIO& io = ImGui::GetIO();
    io.AddMousePosEvent((float)x / io.DisplayFramebufferScale.x, (float)y / io.DisplayFramebufferScale.x);
}
...
static void ImGui_ImplGlfw_UpdateMouseData()
{
    ...
    if (is_app_focused)
    {
        ...
        if (is_app_focused && bd->MouseWindow == NULL)
        {
            ...
            io.AddMousePosEvent((float)mouse_x / io.DisplayFramebufferScale.x, (float)mouse_y / io.DisplayFramebufferScale.y);
        }
    }
}
...
void ImGui_ImplGlfw_NewFrame()
{
    ...
    glfwGetWindowContentScale(bd->Window, &scale_x, &scale_y);
    io.DisplaySize = ImVec2((float)w / scale_x, (float)h / scale_x);
    if (w > 0 && h > 0)
